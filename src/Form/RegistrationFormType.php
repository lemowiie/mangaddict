    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('agreeTerms', CheckboxType::class, [
                'mapped' => false,
                'label' => 'J\'accepte les conditions générales (CGU)',
                'constraints' => [
            ...
            ->add('plainPassword', PasswordType::class, [
                ...
                'constraints' => [
                    ...
                    // CORRECTION ICI : Utilisation des arguments nommés (min:, max:, etc.)
                    // au lieu d'un tableau ([]) qui cause l'erreur "must be of type ?int, array given"
                    new Length(
                        min: 6,
